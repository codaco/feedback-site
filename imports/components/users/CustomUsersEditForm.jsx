...
class CustomUsersEditForm extends React.Component {
    constructor(props) {
        super(props);
                ...
                <div className="page users-edit-form">
                    ...
                    <Components.SmartForm
                        ...
                        successCallback={user => {
                            ...
                            // this.props.flash({ id: 'users.edit_success', name: Users.getDisplayName(user), type: 'success'});
                        }}
                        showRemove={true}
                    />
                </div>
...
CustomUsersEditForm.propTypes = {
    terms: PropTypes.object, // a user is defined by its unique _id or its unique slug
};

CustomUsersEditForm.contextTypes = {
    intl: intlShape
};

CustomUsersEditForm.displayName = 'UsersEditForm';

replaceComponent('UsersEditForm', CustomUsersEditForm);
